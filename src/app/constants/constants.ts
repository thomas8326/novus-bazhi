...
export const 五行相生: Map<五行, number[]> = new Map();
// 0 = 金, 1 = 水, 2 = 木, 3 = 火, 4 = 土
五行相生.set(五行.金, [0, 1, 2, 3, 4]);
五行相生.set(五行.木, [2, 3, 4, 0, 1]);
五行相生.set(五行.火, [3, 4, 0, 1, 2]);
五行相生.set(五行.土, [4, 0, 1, 2, 3]);
五行相生.set(五行.水, [1, 2, 3, 4, 0]);
