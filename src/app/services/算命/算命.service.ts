...
export class 算命服務器 {
  ...
  private 計算流月天干地支(
    ...
    // 大運流年相合 => 流月+本命
    // const createData = () => {
    //   const 流年流月合 = this.流年流月相合(horoscopeResult, yearFortune, liuYueGanZhi);
    //   const 流月剋流年 = this.流月剋流年(horoscopeResult, liuYueGanZhi, yearFortune);
    //   const 流年剋流月 = this.流年剋流月(horoscopeResult, yearFortune, liuYueGanZhi);
